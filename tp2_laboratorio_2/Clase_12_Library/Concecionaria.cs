...
namespace Clase_12_Library
{
    public class Concesionaria 
    {
        ...
        /// <returns></returns>
        public string Mostrar(ETipo tipoDeVehiculo)
        {
            StringBuilder sb = new StringBuilder();

            sb.AppendFormat("Tenemos {0} lugares ocupados de un total de {1} disponibles", this._vehiculos.Count, this._espacioDisponible);
            sb.AppendLine("");
